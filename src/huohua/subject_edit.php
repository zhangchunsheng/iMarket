 ...
 * 应用编辑
 *
 * @version        $Id: app_edit.php 1 16:09 2010年7月20日Z tianya $
...
if($dopost!='save') {
        ...
        if(is_array($dtp->CTags)) {
            foreach($dtp->CTags as $ctag) {
                if($ctag->GetName()=='link') {
                    ...
                    $nForm .= "<div style='line-height:36px'>应用地址{$newRowStart}：<input type='text' name='softurl{$newRowStart}' style='width:280px' value='".trim($ctag->GetInnerText())."' />
    ...
    $tags = GetTags($aid);
    include DedeInclude("templets/app_edit.htm");
    exit();
}
/*--------------------------------
function __save(){  }
-------------------------------*/
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='soft_add.php?cid=$typeid'><u>发布新应用</u></a>
    &nbsp;&nbsp;
