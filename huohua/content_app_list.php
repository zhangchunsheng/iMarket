 ...
 * 应用列表
 *
 * @version        $Id: content_app_list.php 1 14:31 2010年7月12日Z tianya $
...
if($arcrank!='') {
    ...
    $CheckUserSend = "<input type='button' class='coolbg np' onClick=\"location='content_app_list.php?cid={$cid}&channelid={$channelid}&dopost=listArchives';\" value='所有文档' />";
} else {
    $CheckUserSend = "<input type='button' class='coolbg np' onClick=\"location='content_app_list.php?cid={$cid}&channelid={$channelid}&dopost=listArchives&arcrank=-1';\" value='稿件审核' />";
}
