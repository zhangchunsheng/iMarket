...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2013-2013 huohua 火花市场 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '火花市场,安卓游戏,安卓软件下载,安卓游戏下载,安卓手机助手,安卓,腾讯应用,应用中心,应用,游戏,android,android app,android应用,免费应用,应用下载,应用排行,应用专题';
$cfg_description = '火花市场一款专门为用户提供安卓应用下载的web产品。一切以用户价值为依归，通过海量丰富的应用、游戏资源，高品质的应用推荐，丰富多彩的用户互动，努力为用户打造贴心、舒心、快乐、健康的移动应用服务平台。';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
